...
const (
	...
	AILAB_ENV_NAMESPACE  = "AILAB_NAMESPACE"
	AILAB_ENV_DEVICE_NUM = "AILAB_DEVICE_NUM"
	AILAB_ENV_COMPACT_MASTER="AILAB_COMPACT_MASTER"

    AILAB_ENV_JOB_TASK_NAME = "VCJOB_TASK_NAME"

    AILAB_OUTPUT_RUN_FILE = ".runfile"
)
const (
...
const (
	...
	AILAB_RESOURCE_TYPE_APWORKSHOP = "apworkshop"
